...
const activeLinkStyle = {
  backgroundColor: "#DC2626", /* Red for active state */
  ...
  return (
    <nav
      style={{
        ...
        boxShadow: "0 2px 10px rgba(34, 139, 34, 0.1)" /* Subtle green shadow */
      }}
    >
      <span style={{ 
        fontWeight: "bold", 
        fontSize: 22,
        color: "#DC2626", /* Red for brand name */
        display: "flex",
        alignItems: "center"
      }}>
        <span style={{
        ...
        <NavLink 
          ...
          onMouseEnter={(e) => {
            if (!e.target.className.includes("active")) {
              ...
              e.target.style.color = "#DC2626"; /* Red text on hover */
            }
          }}
          onMouseLeave={(e) => {
            if (!e.target.className.includes("active")) {
